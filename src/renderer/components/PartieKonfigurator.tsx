            ...
            <div className="grid grid-cols-2 gap-8">
              <div>
                <InputLabel
                  ...
                  validator={
                    new InputValidator(InputValidator.TYPE_NUMBER, {
                      number: {
                        ifSmallerThen: {
                          number: 3,
                          error:
                            'Unpassende Rundenanzahl. Das Spiel wäre sehr schnell vorbei!',
                        },
                        ifBiggerThen: {
                          number: 1000,
                          error:
                            'Unpassende Rundenanzahl. Das Spiel würde sehr lange dauern!',
                        },
                      },
                    })
                  }
                ...
                <InputLabel
                  ...
                  onChange={(value) => {
                    this.setState({
                      values: {
                        ...values,
                        characterChoiceTimeout: Number.parseFloat(
                          value.toString()
                        ),
                      },
                    });
                ...
                <InputLabel
                  ...
                  onChange={(value) => {
                    this.setState({
                      values: {
                        ...values,
                        cardSelectionTimeout: Number.parseFloat(
                          value.toString()
                        ),
                      },
                    });
