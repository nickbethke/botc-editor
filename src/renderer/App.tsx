...
class App extends React.Component<AppProps, AppStates> {
	...
	homeScreen() {
		...
		return (
			<div
				className="text-white transition duration-500 dark:bg-gradient-to-br bg-gradient-to-bl dark:from-slate-900 dark:to-muted-800 from-slate-400 to-muted-500 overflow-hidden">
